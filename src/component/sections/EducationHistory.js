...
const EducationHistory = ({ currentSection, setCurrentSection }) => {
  ...
  return (
    <div className="mt-4">
      ...
      <form>
        <CardField
          title="152. What is your highest level of education?"
          type="radio"
        ...
        <CardField
          title="153. What grades did you mostly receive during your education (choose all that apply)?"
          type="checkbox"
        ...
        <CardField
          title="154. Were you ever identified as having a learning disability, or placed in any special education classes?"
          type="radio"
        ...
        <CardField
          title="155. Did you graduate high school?"
          type="radio"
        ...
        <CardField
          title="156. Did you go to college"
          type="radio"

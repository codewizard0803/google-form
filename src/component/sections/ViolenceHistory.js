...
const ViolenceHistory = ({ currentSection, setCurrentSection }) => {
  ...
  return (
    <div className="mt-4">
      ...
      <form>
        <CardField
          title="164. Have you ever been involved in physical altercations?"
          type="radio"
        ...
        <CardField
          title="165. Do you currently or have you recently had thoughts of wanting to hurt anyone?"
          type="radio"
        ...
        <CardField
          title="166. Have you ever been the victim of violence?"
          type="radio"

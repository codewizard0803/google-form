...
const EmploymentInjuryPhysical = ({ currentSection, setCurrentSection }) => {
  const {employmentInjuryPhysical, setEmploymentInjuryPhysical}= useGlobalContext();
          ...
          <Card sx={{ width: "65%", margin: "auto", marginTop: 3 }}>
            <CardContent>
              <Typography sx={{ fontSize: 25, textAlign: "left" }}>
                Do You Currently Receive Disability In Connection With Your
                Claim?
              </Typography>
              <p className="h-0.5 bg-gray-400 w-100 mt-2"></p>
              <div className="mt-5">
                  ...
                  <div className="text-left">
                    ...
                    "Yes" ? (
                      <RadioFollowUp
                        ...
                        checked={
                          employmentInjuryPhysicalValue.currentDisability
                        }
                  ...
                  <div className="text-left">
                    ...
                    "Yes" ? (
                      <div className="w-[95%] mx-auto p-2 shadow-lg">
                        ...
                        <div className="p-3 mt-3">
                          <p className="text-left text-[23px]">
                            Please List Separately and Explain Each Conflict
                            that Occurred:
                          </p>
                          <p className="h-0.5 bg-gray-400 w-100 mt-2"></p>
                          <div className="form-group">
                            <input
                              ...
                              name="eachConflicts"
                              value={
                                employmentInjuryPhysicalValue?.eachConflicts
                              }
                              onChange={handleChange}
                            />
                        ...
                        <div className="p-3 mt-3">
                          ...
                          <div className="form-group">
                            <input
                              ...
                              name="conflictsRate"
                              value={
                                employmentInjuryPhysicalValue?.conflictsRate
                              }
                              onChange={handleChange}
                            />
                  ...
                  <div className="text-left">
                    <label>
                      <input
                        ...
                        className="mr-2"
                        checked={
                          employmentInjuryPhysicalValue?.verbalWarning ===
                          "Yes"
                        }
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    "Poor" ? (
                      <div className="w-[95%] mx-auto p-2 shadow-lg">
                        <p className="text-left text-[23px] mt-3">
                          Please give the names and reasons this relationship
                          was poor.
                        </p>
                        <p className="h-0.5 bg-gray-400 w-100 mt-2"></p>
                        <input
                  ...
                  <div className="text-left">
                    <label>
                      <input
                        ...
                        className="mr-2"
                        checked={
                          employmentInjuryPhysicalValue?.lastStraw ===
                          "Yes"
                        }
                    ...
                    "Yes" ? (
                      ...
                      <input
                        ...
                        value={
                          employmentInjuryPhysicalValue?.explainLastStraw
                        }
                        onChange={handleChange}
                      />
                      {errors.explainLastStraw && (
